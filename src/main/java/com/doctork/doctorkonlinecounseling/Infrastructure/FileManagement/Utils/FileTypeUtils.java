...
public class FileTypeUtils {
    ...
    public static String getFileType(byte[] inputBytes) {
        ...
        try {
            ...
            if (type.equalsIgnoreCase("doc") || type.equalsIgnoreCase("docx")
                    ...
                    || type.equalsIgnoreCase("pptx") || type.equalsIgnoreCase("xlsx")
                    || type.equalsIgnoreCase("xls") || type.equalsIgnoreCase("jar")
