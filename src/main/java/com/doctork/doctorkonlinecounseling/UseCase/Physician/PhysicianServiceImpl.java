...
public class PhysicianServiceImpl implements PhysicianService {
    ...
    public PhysicianServiceImpl( PhysicianMiscellaneousServiceImpl doctorMiscellaneousService, PhysicianRepository physicianRepository, PhysicianMongoRepository physicianMongoRepository) {
