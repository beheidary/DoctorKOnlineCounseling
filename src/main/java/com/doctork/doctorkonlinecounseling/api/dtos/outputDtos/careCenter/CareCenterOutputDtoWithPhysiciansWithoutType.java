...
public class CareCenterOutputDtoWithPhysiciansWithoutType {
    ...
    public CareCenterOutputDtoWithPhysiciansWithoutType(Long id, String descriptions, String address, String centerName, String callNumber, Status status, Double latitude, String cityTitle, String provinceTitle, Double longitude, String imageName, List<PhysicianOutputDto> physicians) {
        this.id = id;
