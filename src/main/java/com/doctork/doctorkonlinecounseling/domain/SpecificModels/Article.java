...
public class Article {
    ...
    public Article(Long id, String group, String title, String subject, String publishedDate, Integer rate, String body, String summery, String picture, Integer number, LocalDateTime saveDateTime, LocalDateTime updateDateTime) {
        this.id = id;
